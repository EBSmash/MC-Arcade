package io.ebs.arcade.gui.click;

import io.ebs.arcade.gui.click.component.Frame;
import io.ebs.arcade.gui.click.component.KeybindButton;
...
public class ClickGui extends GuiScreen {
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) {
        ...
        for (Module module : ModuleManager.getModules()) {
            if (module.isToggled()) {
                if (module.onGuiClick(x, y, mouseButton)) {
                    return;
                }
            }
        }
