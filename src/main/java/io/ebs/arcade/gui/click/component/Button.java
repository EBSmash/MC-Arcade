    ...
    public void render(int mouseX, int mouseY, int x, int y) {
        if (frame.open) {
            ...
            if (module.isToggled()) {
                ...
                Arcade.clickGui.drawString(Arcade.clickGui.mc.fontRenderer, module.getName(), this.x + 3, (this.y + this.height / 2) + Arcade.clickGui.getYOffset() - Arcade.clickGui.getTextYOffset(), Arcade.clickGui.getEnabledButtonTextColour());
            } else {
                Gui.drawRect(this.x, this.y + Arcade.clickGui.getYOffset(), this.x + this.width, this.y + height + Arcade.clickGui.getYOffset() - 1, Arcade.clickGui.getButtonColour());
                Arcade.clickGui.drawString(Arcade.clickGui.mc.fontRenderer, module.getName(), this.x + 3, (y + this.height / 2) + Arcade.clickGui.getYOffset() - Arcade.clickGui.getTextYOffset(), Arcade.clickGui.getButtonTextColour());
            }
